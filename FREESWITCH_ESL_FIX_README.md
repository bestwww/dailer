...
# Проблема SpanDSP при сборке FreeSWITCH

## ✅ **ПРОБЛЕМА РЕШЕНА** - 2025-01-25
...
### 🔧 **Решение:**
Отключены модули SpanDSP в конфигурации FreeSWITCH:
- `--disable-mod-spandsp`
- `--disable-mod-fax` 
- `--disable-mod-t38gateway`

### 📝 **Что изменилось:**
1. **Убраны зависимости:** libspandsp-dev, libtiff-dev, libfftw3-dev
2. **Упрощена сборка:** меньше времени компиляции
3. **Сохранена функциональность:** Event Socket Library работает
4. **Стабильность:** нет зависимости от проблемных пакетов Debian

### ⚠️ **Что потеряли:**
- Поддержка T.38 факсов
- Модуль mod_spandsp для аудио DSP
- Некоторые расширенные аудио функции

### 🎯 **Для проекта Dailer:**
Эти функции не критичны для системы автодозвона.
Event Socket Library полностью функциональна.
